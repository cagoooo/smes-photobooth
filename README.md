...
> 📌 **建置版本：2026.06.15-7**（依據 `version.json`）
...
石門國小 AI 智慧拍貼機：手勢倒數自拍、可換邊框、拍照上傳 Google 雲端硬碟、掃 QR 下載。純前端 + GAS，全免費。

- 專案定位：教育科技／教學支援專案
- Repository：`cagoooo/smes-photobooth`
- 可見性：公開
- 主要技術：HTML
- 線上入口：<https://cagoooo.github.io/smes-photobooth/>
